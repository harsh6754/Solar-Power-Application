...
const Chatbot = () => {
  ...
  const handleSend = async () => {
    ...
    if (isRelated) {
      ...
      setMessages((prevMessages) => [
        ...
        {
          sender: "bot",
          text: "Sorry, I can only answer questions related to solar power and our website!",
        },
      ]);
    }
  ...
  const getAIResponse = async (userMessage) => {
    const prompt = `You are a chatbot on a solar power website. Only answer questions related to solar power, installation, maintenance, costs, savings, environmental benefits, or the products and services offered on the website. 
    User: ${userMessage}`;
      ...
      {isOpen && (
        <div className="fixed bottom-16 right-4 w-72 bg-white shadow-lg rounded-lg flex flex-col z-50">
          <div className="p-4 bg-blue-500 text-white rounded-t-lg">
            <h3 className="text-lg font-bold">Solar Power Chatbot</h3>
          </div>
          <div
