...
//   const fetchRandomImageUrl = async () => {
//     const imageFiles = [
//       'gs://t-music-be993.appspot.com/Solar/panel1.jpg',
//       'gs://t-music-be993.appspot.com/Solar/panel2.jpg',
//       'gs://t-music-be993.appspot.com/Solar/panel3.jpg',
//     ];

//     const randomFile = imageFiles[Math.floor(Math.random() * imageFiles.length)];

//     try {
//       const fileRef = ref(storage, randomFile);
//       const url = await getDownloadURL(fileRef);
//       return url;
//     } catch (error) {
//       console.error('Error fetching random image URL:', error.message);
//       return ''; // Fallback empty string if fetch fails
//     }
//   };
...
//         if (prevProgress >= 100) {
//           clearInterval(interval);
//           navigate('/main'); // Redirect after loading completes
//           return 100;
//         }
